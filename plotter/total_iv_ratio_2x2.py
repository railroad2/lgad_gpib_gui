...
plotter.add_input_data(input_data_pad1, label="Pad 1", color=colors[0], linewidth=2, ratio=(2,3))
plotter.add_input_data(input_data_pad2, label="Pad 2", color=colors[1], linewidth=2, ratio=(2,3))
plotter.add_input_data(input_data_pad3, label="Pad 3", color=colors[2], linewidth=2, ratio=(2,3))
plotter.add_input_data(input_data_pad4, label="Pad 4", color=colors[3], linewidth=2, ratio=(2,3))
...
plotter.save_fig(out_name=sensor_name+'_ratio_iv')
