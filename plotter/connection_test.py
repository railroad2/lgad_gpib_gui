...
sensor_name = 'W9b'
probecard = 'C:/LGAD_test/I-V_test/'+sensor_name+'/IV_SMU+PAU_'+sensor_name+'_new_setup_'+date+'_'+'col1_row1_v3.txt'
plotter.add_input_data(probecard, label="Pad", y_index=3, color=colors[0], linewidth=3, draw_half=True, y_scale=1e3, flip_y=True)

probecard = 'C:/LGAD_test/I-V_test/'+sensor_name+'/IV_SMU+PAU_'+sensor_name+'_new_setup_'+date+'_'+'col1_row1_v3.txt'
plotter.add_input_data(probecard, label="Total", y_index=2, color=colors[1], linewidth=3, draw_half=True, y_scale=1e3, flip_y=True)
