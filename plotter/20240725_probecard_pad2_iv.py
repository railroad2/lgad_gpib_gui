...
date = '2024-07-25'
sensor_name = 'Probecard_connector1_pin2'
initial_voltage = '0'
final_voltage = '-250'
...
plotter.add_input_data(input_data_pad2, label="Second return sweep", color=colors[1], linewidth=2, linestyle='--', draw_second_half=True)
