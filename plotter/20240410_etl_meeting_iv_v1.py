...
plotter.get_current_axis().set_axis_off()

label = "Without switch"
# plotter.add_input_data(input_data_pad1, label=label)
plotter.add_input_data(input_data_pad2, (0, 0), label=label, color='black')
plotter.add_input_data(input_data_pad3, (0, 1), label=label, color='black')
plotter.add_input_data(input_data_pad4, (1, 0), label=label, color='black')

label = "Switch v1"
# plotter.add_input_data(input_data_pad1_switch_v1, label=label)
plotter.add_input_data(input_data_pad2_switch_v1, (0, 0), label=label)
plotter.add_input_data(input_data_pad3_switch_v1, (0, 1), label=label)
plotter.add_input_data(input_data_pad4_switch_v1, (1, 0), label=label)

label = "Switch v2"
# plotter.add_input_data(input_data_pad1_switch_v2, label=label)
plotter.add_input_data(input_data_pad2_switch_v2, (0, 0), label=label)
plotter.add_input_data(input_data_pad3_switch_v2, (0, 1), label=label)
plotter.add_input_data(input_data_pad4_switch_v2, (1, 0), label=label)
...
plotter.write_text("Pad 2", location=(0, 0))
plotter.write_text("Pad 3", location=(0, 1))
plotter.write_text("Pad 4", location=(1, 0))
...
plotter.save_fig(out_name='20240410_iv_v1')
