...
input_data_pad2 = 'C:/LGAD_test/I-V_test/'+date+'_'+sensor_name+'/IV_SMU+PAU_'+sensor_name+'_'+date+'_'+initial_voltage+'_'+final_voltage+'_pad0_2_3_4_5.txt'
...
plotter.add_input_data(input_data_pad1, label="before broken test", color=colors[0], linewidth=2, draw_half=True)
plotter.add_input_data(input_data_pad2, label="after broken test", color=colors[1], linewidth=2, linestyle='--', draw_half=True)
...
plotter.set_experiment_label(location=(0, 0), label='W5b sliced pad', fontsize=20)
...
plotter.save_fig(out_name=sensor_name+'broken_recovered_iv')
