...
sensor_name = 'JH_241004'
description = 'Mid_06X06'
date = '2024-10-04'
coln = 'col6'
rown = 'row6'
version = '0'
txt_path = make_txt_path(sensor_name, description, date, coln, rown, version)
plotter.add_input_data(txt_path, label= 'New sensor,' +coln + ' ' + rown, y_index=3, color=colors[4], linewidth=2, draw_half=True, y_scale=1e3, flip_y=True)
