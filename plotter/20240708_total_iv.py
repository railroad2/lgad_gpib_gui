...
plotter.add_input_data(input_data_pad1, label="Pad 1", y_index=2, color=colors[0], linewidth=2, draw_half=True, y_scale=1e3)
plotter.add_input_data(input_data_pad1, label="Total", y_index=1, color=colors[4], linewidth=2, draw_half=True, y_scale=1e3, flip_y=True)
...
plotter.set_experiment_label(location=(0, 0), label='K1 W1 16x16 (2-4) measured in Torino', fontsize=20)
