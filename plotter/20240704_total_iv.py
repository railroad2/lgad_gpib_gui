...
plotter.add_input_data(input_data_pad1, label="Total", y_index=2, color=colors[1], linewidth=2, draw_half=True, y_scale=1e3, flip_y=True)
plotter.add_input_data(input_data_pad2, label="Total", y_index=2, color=colors[2], linewidth=2, draw_half=True, y_scale=1e3, flip_y=True)
plotter.add_input_data(input_data_pad3, label="Total", y_index=2, color=colors[3], linewidth=2, draw_half=True, y_scale=1e3, flip_y=True)
plotter.add_input_data(input_data_pad4, label="Total", y_index=2, color=colors[4], linewidth=2, draw_half=True, y_scale=1e3, flip_y=True)
plotter.add_input_data(input_data_pad5, label="Total", y_index=2, color=colors[5], linewidth=2, draw_half=True, y_scale=1e3, flip_y=True)
