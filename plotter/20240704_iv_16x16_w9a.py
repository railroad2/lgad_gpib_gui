...
input_data_pad5 = 'C:/LGAD_test/I-V_test/'+date+'_'+sensor_name+'/IV_SMU+PAU_'+sensor_name+'_'+date+'_'+initial_voltage+'_'+final_voltage+'_pad4.txt'
input_data_pad6 = 'C:/LGAD_test/I-V_test/'+date+'_'+sensor_name+'/IV_SMU+PAU_'+sensor_name+'_'+date+'_'+initial_voltage+'_'+final_voltage+'_pad5.txt'

sensor_name = 'FBK_w9a_two_contact_column+3_test'
input_data_four_contact_pad1 = 'C:/LGAD_test/I-V_test/'+date+'_'+sensor_name+'/IV_SMU+PAU_'+sensor_name+'_'+date+'_'+initial_voltage+'_'+final_voltage+'_pad5.txt'
...
plotter.add_input_data(input_data_pad2, label="Row 1", color=colors[1], linewidth=2)
plotter.add_input_data(input_data_pad3, label="Row 2", color=colors[2], linewidth=2)
plotter.add_input_data(input_data_pad4, label="Row 3", color=colors[3], linewidth=2)
plotter.add_input_data(input_data_pad5, label="Row 4", color=colors[4], linewidth=2)
plotter.add_input_data(input_data_pad6, label="Row 5", color=colors[5], linewidth=2)
...
plotter.set_experiment_label(location=(0, 0), label='W9a', fontsize=20)
...
plotter.save_fig(out_name='20240704_16x16_w9a')
