...
#plotter.get_current_axis().set_yscale('log')
plotter.set_y_lim((-2.0E-8, 2.5e-8), location=(0, 0))
plotter.set_y_lim((-2.0E-8, 2.5e-8), location=(0, 1))
plotter.set_y_lim((-3.0E-8, 2.5e-8), location=(1, 0))
plotter.set_y_lim((-2.5E-8, 2.5e-8), location=(1, 1))
...
plotter.save_fig(out_name='20240416_iv_step2_v1_offset')
