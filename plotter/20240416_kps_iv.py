...
input_data_pad1 = 'C:/LGAD_test/I-V_test/'+date+'_'+sensor_name+'/IV_SMU+PAU_'+sensor_name+'_'+date+'_'+initial_voltage+'_'+final_voltage+'_pad1_2.txt'
input_data_pad2 = 'C:/LGAD_test/I-V_test/'+date+'_'+sensor_name+'/IV_SMU+PAU_'+sensor_name+'_'+date+'_'+initial_voltage+'_'+final_voltage+'_pad2_2.txt'
input_data_pad3 = 'C:/LGAD_test/I-V_test/'+date+'_'+sensor_name+'/IV_SMU+PAU_'+sensor_name+'_'+date+'_'+initial_voltage+'_'+final_voltage+'_pad3_2.txt'
input_data_pad4 = 'C:/LGAD_test/I-V_test/'+date+'_'+sensor_name+'/IV_SMU+PAU_'+sensor_name+'_'+date+'_'+initial_voltage+'_'+final_voltage+'_pad4_2.txt'

sensor_name = 'FBK_34_step2_v1_5'
...
sensor_name = 'FBK_34_step2_v2_5'
input_data_pad1_switch_v2 = 'C:/LGAD_test/I-V_test/'+date+'_'+sensor_name+'/IV_SMU+PAU_'+sensor_name+'_'+date+'_'+initial_voltage+'_'+final_voltage+'_pad1_2.txt'
input_data_pad2_switch_v2 = 'C:/LGAD_test/I-V_test/'+date+'_'+sensor_name+'/IV_SMU+PAU_'+sensor_name+'_'+date+'_'+initial_voltage+'_'+final_voltage+'_pad2_2.txt'
input_data_pad3_switch_v2 = 'C:/LGAD_test/I-V_test/'+date+'_'+sensor_name+'/IV_SMU+PAU_'+sensor_name+'_'+date+'_'+initial_voltage+'_'+final_voltage+'_pad3_2.txt'
input_data_pad4_switch_v2 = 'C:/LGAD_test/I-V_test/'+date+'_'+sensor_name+'/IV_SMU+PAU_'+sensor_name+'_'+date+'_'+initial_voltage+'_'+final_voltage+'_pad4_2.txt'
...
plotter.draw(x_index=0, y_index=3, remove_offset=False, flip_x=True, flip_y=True, draw_second_half=True)
...
plotter.get_current_axis().set_yscale('log')
#plotter.set_y_lim((0.0E-9, 1.2e-8), location=(0, 1))
#plotter.set_y_lim((0.0E-9, 1.2e-8), location=(1, 0))
#plotter.set_y_lim((0.0E-9, 1.2e-8), location=(1, 1))
...
plotter.set_experiment_label(location=(0, 0), label='FBK 2x2 2022v1 34 T10', fontsize=15)
...
plotter.save_fig(out_name='20240416_kps_iv')
